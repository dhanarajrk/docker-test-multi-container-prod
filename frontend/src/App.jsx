...
function App() {
  ...
  useEffect(()=>{
    ...
    fetch("http://3.110.42.127:5000/") //Replaced localhost with EC2 instance Public ipv4 address cause that VM is a PC now and its name is identified as 3.110.42.127 not as localhost. 
    .then(res => res.text())
